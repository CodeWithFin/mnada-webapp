    ...
    <div className="min-h-screen bg-[#f8f8f8] flex flex-col md:flex-row">
      <aside className="w-full md:w-64 bg-white border-r border-[#e5e5e5] flex flex-col shrink-0">
        ...
        <div className="flex flex-col py-6 gap-2">
          ...
          <Link
            href="/admin/faq"
            className={`px-8 py-3 flex items-center gap-3 text-sm font-mono uppercase tracking-widest transition-colors ${pathname.startsWith("/admin/faq") ? "text-[#a58c69] font-bold bg-[#f8f8f8]" : "text-gray-500 hover:text-[#1c1a19] hover:bg-[#fafafa]"}`}
          >
            <Icon icon="lucide:message-circle-question" width="18" /> FAQs
          </Link>
